...
MASTER_PROMPT_PATH = BASE_DIR / "prompts" / "master_prompt_rag_eval_en.txt"
USER_INPUT_DIR = BASE_DIR / "user_input"
FOLDS_PATH = BASE_DIR / "cv_folds" / "hie_db_folds.json"
RESULTS_BASE_DIR = BASE_DIR / "results" / "rag"
...
def build_prompt(
    ...
    for i, case in enumerate(retrieved_cases, start=1):
        ...
        expert_reduction = case.get("expert_reduction_json", {})
        financial_case = case.get("financial_data_json", {})

        parts.append("expert_advice_text:")
        parts.append(str(advice_text))
        parts.append("")
        parts.append("expert_reduction_json:")
        parts.append(json.dumps(expert_reduction, ensure_ascii=False))
        parts.append("")
...
def retrieve_similar_cases(
    ...
    for match in matches:
        ...
        result = {
            ...
            "expert_reduction_json": parse_json_field(
                metadata.get("expert_reduction_json")
            ),
